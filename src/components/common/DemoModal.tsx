            ...
            {isOpen && (
                ...
                >
                        ...
                        >
                            <button
                                onClick={handleClose}
                                className="absolute top-4 right-4 text-white hover:text-[#7c3aed] transition"
                            >
                                <X className="w-5 h-5" />
                            </button>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                <input
                                    ...
                                    required
                                    className="w-full rounded-lg border border-white/20 bg-transparent px-4 py-2 text-white placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-[#7c3aed] transition"
                                />
                                <input
                                    type="text"
                                    name="companyName"
                                    ...
                                    <div className="flex">
                                        <div className="relative">
                                            <button
                                                ...
                                                className="flex items-center gap-2 px-3 py-2 rounded-l-lg border border-white/20 bg-transparent text-white hover:bg-white/5 focus:outline-none focus:ring-2 focus:ring-[#7c3aed] transition"
                                            >
                                                    ...
                                                    >
                                                        <div className="p-2 border-b border-white/10">
                                                            <input
                                                                ...
                                                                className="w-full px-3 py-2 bg-neutral-700 border border-white/20 rounded text-white placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-[#7c3aed] text-sm"
                                                                autoFocus
                                                            />
                                                        </div>
                                        ...
                                        <input
                                            ...
                                            onChange={handleChange}
                                            required
                                            className="flex-1 rounded-r-lg border-l-0 border border-white/20 bg-transparent px-4 py-2 text-white placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-[#7c3aed] transition"
                                        />
                                    </div>
                                </div>
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    rows={3}
                                    className="w-full rounded-lg border border-white/20 bg-transparent px-4 py-2 text-white placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-[#7c3aed] transition resize-none"
                                />
                                <button
                                    type="submit"
