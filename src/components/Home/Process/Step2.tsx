...
const Step2 = () => {
    ...
    const codeLines = [
        { text: 'const', color: 'text-purple-400 dark:text-purple-400', type: 'keyword' },
        { text: ' integrations = {', color: 'text-gray-900 dark:text-white', type: 'normal' },
        { text: '\n  ', color: 'text-gray-900 dark:text-white', type: 'normal' },
        { text: 'shopify:', color: 'text-cyan-500 dark:text-cyan-400', type: 'keyword' },
        { text: ' { status: ', color: 'text-gray-900 dark:text-white', type: 'normal' },
        { text: '"connected"', color: 'text-amber-600 dark:text-yellow-400', type: 'string' },
        { text: ' },', color: 'text-gray-900 dark:text-white', type: 'normal' },
        { text: '\n  ', color: 'text-gray-900 dark:text-white', type: 'normal' },
        { text: 'metaAds:', color: 'text-cyan-500 dark:text-cyan-400', type: 'keyword' },
        { text: ' { status: ', color: 'text-gray-900 dark:text-white', type: 'normal' },
        { text: '"syncing"', color: 'text-blue-600 dark:text-blue-400', type: 'function' },
        { text: ' },', color: 'text-gray-900 dark:text-white', type: 'normal' },
        { text: '\n  ', color: 'text-gray-900 dark:text-white', type: 'normal' },
        { text: 'googleAds:', color: 'text-slate-600 dark:text-gray-400', type: 'keyword' },
        { text: ' { status: ', color: 'text-gray-900 dark:text-white', type: 'normal' },
        { text: '"ready"', color: 'text-amber-600 dark:text-yellow-400', type: 'string' },
        { text: ' },', color: 'text-gray-900 dark:text-white', type: 'normal' },
        { text: '\n  ', color: 'text-gray-900 dark:text-white', type: 'normal' },
        { text: 'klaviyo:', color: 'text-slate-600 dark:text-gray-400', type: 'keyword' },
        { text: ' { status: ', color: 'text-gray-900 dark:text-white', type: 'normal' },
        { text: '"ready"', color: 'text-amber-600 dark:text-yellow-400', type: 'string' },
        { text: ' }', color: 'text-gray-900 dark:text-white', type: 'normal' },
        { text: '\n};', color: 'text-gray-900 dark:text-white', type: 'normal' }
        ...
        <div className="bg-white/10 dark:bg-black/20 backdrop-blur-xl border border-white/20 dark:border-white/10 text-gray-900 dark:text-white p-6 w-[26rem] h-80 rounded-xl shadow-2xl shadow-black/30 dark:shadow-black/30 flex flex-col">
            <div className="flex flex-col mb-4">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-xs leading-tight">
                    Link Meta Ads, Google Ads, and Klaviyo to track true ROAS and customer acquisition costs.
                </p>
            </div>
