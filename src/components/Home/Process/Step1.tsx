...
const Step1 = () => {
    const analyzingSteps = [
        { icon: Shield, label: 'Store verification' },
        { icon: Settings, label: 'OAuth setup' },
        { icon: ParkingMeter, label: 'Data sync' },
        { icon: NotebookTabs, label: 'Order history' },
        { icon: Repeat, label: 'Product catalog' },
    ];
    ...
    return (
        <div className="bg-white/10 dark:bg-black/20 backdrop-blur-xl border border-white/20 dark:border-white/10 text-gray-900 dark:text-white p-6 w-[26rem] h-80 rounded-2xl shadow-2xl shadow-black/30 dark:shadow-black/30 flex flex-col">
            ...
            <div className="flex flex-col mb-4">
                ...
                <h2 className="text-xl font-bold mb-1 text-gray-900 dark:text-white">Shopify Connection</h2>
                <p className="text-gray-600 dark:text-gray-300 text-xs leading-tight">
                    One-click OAuth setup imports 30 days of orders, customers, and product data instantly.
                </p>
            </div>
            ...
            <div className="flex">
                <div className="border-gray-300/30 dark:border-white/30 rounded-lg p-4 border-[1px] backdrop-blur-sm bg-white/5 dark:bg-black/20 shadow-lg">
                    <div className="flex-1 flex flex-col items-center justify-center">
                            ...
                            <div className="absolute inset-0 rounded-full border border-gray-300/30 dark:border-white/20 bg-white/20 dark:bg-black/50 backdrop-blur-sm shadow-inner">
                                ...
                                <div className="absolute inset-0 rounded-full overflow-hidden">
                                    <div
                                        ...
                                        style={{
                                            background: 'conic-gradient(from 0deg, transparent 0deg, #7c3aedaa 20deg, transparent 40deg)',
                                            animationDuration: '3s',
                                        }}
                                    />
                                </div>
                                <div className="absolute top-1/2 left-1/2 w-1.5 h-1.5 bg-[#7c3aed] rounded-full transform -translate-x-1/2 -translate-y-1/2 shadow-lg shadow-[#7c3aed]/50" />
                        ...
                        <p className="text-xs text-gray-600 dark:text-white/70">Connecting to Shopify...</p>
                    </div>
                </div>
                <div className="space-y-1 border border-gray-300/30 dark:border-white/20 rounded-lg p-2 ml-4 flex-1 backdrop-blur-sm bg-white/5 dark:bg-black/10 shadow-lg">
                    {analyzingSteps.map((step, idx) => (
                        ...
                        >
                            <span className="text-[#7c3aed] drop-shadow-sm"><step.icon size={16} /></span>
