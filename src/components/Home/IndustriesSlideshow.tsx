...
const products = [
  ...
  },
  {
    ...
    image: ind7,
    href: "/products/shopsoverse-ar-vr-mr-platform",
  },
  {
    id: 6,
    name: "MendyOps",
        ...
        {products.map((product, i) => (
          <SwiperSlide key={product.id}>
            <div
              ...
              className="rounded-2xl p-[1px] mx-3 bg-gradient-to-br from-[#7c3aed]/30 via-transparent to-blue-500/30 shadow-[0_8px_30px_rgba(0,0,0,0.12)] h-full cursor-pointer"
            >
