            ...
            className="space-y-4 mt-6 w-full max-w-md mx-auto bg-white/40 dark:bg-black/40 backdrop-blur-lg p-6 rounded-2xl border border-black/10 dark:border-white/10 shadow-[0_4px_60px_rgba(0,0,0,0.3)] z-10 ring-1 ring-black/5 dark:ring-white/5"
                >
                    <input
                        ...
                        required
                        className="w-full rounded-lg border border-black/20 dark:border-white/20 bg-transparent px-4 py-2 text-black dark:text-white placeholder:text-black/60 dark:placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-[#7c3aed] transition"
                    />
                        ...
                        <div className="flex">
                            <div className="relative">
                                <button
                                    ...
                                    className="flex items-center gap-2 px-3 py-2 rounded-l-lg border border-black/20 dark:border-white/20 bg-transparent text-black dark:text-white hover:bg-black/5 dark:hover:bg-white/5 focus:outline-none focus:ring-2 focus:ring-[#7c3aed] transition"
                                >
                                        ...
                                        >
                                            <div className="p-2 border-b border-black/10 dark:border-white/10">
                                                <input
                                                    ...
                                                    className="w-full px-3 py-2 bg-gray-100 dark:bg-neutral-700 border border-black/20 dark:border-white/20 rounded text-black dark:text-white placeholder:text-black/60 dark:placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-[#7c3aed] text-sm"
                                                    autoFocus
                                                />
                                            </div>
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                required
                                className="flex-1 rounded-r-lg border-l-0 border border-black/20 dark:border-white/20 bg-transparent px-4 py-2 text-black dark:text-white placeholder:text-black/60 dark:placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-[#7c3aed] transition"
                            />
                        </div>
                    </div>
                    ...
                    <textarea
                        ...
                        onChange={handleChange}
                        rows={3}
            className="w-full rounded-lg border border-black/20 dark:border-white/20 bg-transparent px-4 py-2 text-black dark:text-white placeholder:text-black/60 dark:placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-[#7c3aed] transition resize-none"
                    />

                    <button
                        type="submit"
                        disabled={isSubmitting}
                        className="w-full bg-[#7c3aed] text-black font-semibold py-2 rounded-lg hover:brightness-110 transition disabled:opacity-60"
                    >
