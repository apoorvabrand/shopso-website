...
import shopsoLight from '../../assets/shopso white green wordmark.png'
import shopsoDark from '../../assets/shopso black green wordmark.png'
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-black dark:text-white max-w-4xl">
          <Image src={logo} alt={"shopso"} height={30} width={30} /> <Image src={shopsoLight} alt={"shopso"} className="dark:block hidden" /> <Image src={shopsoDark} alt={"shopso"} className="dark:hidden block" /> Operational Timeline
        </h2>
        ...
        <p className="text-neutral-600 dark:text-neutral-400 text-sm md:text-base max-w-3xl">
          ShopSo follows a <strong>6-step cycle</strong> to deliver intelligent automation solutions that are efficient, scalable, and tailored to your needs.
        </p>
      </div>
