...
// Removed image imports for ShopSo text-based logo
      ...
      {items.map((item, idx) => (
        ...
        >
          ...
          >
            ...
            <div
              className={`absolute inset-0 h-full w-full rounded-full bg-[#7c3aed] z-10 transition-opacity duration-150 ${
            ...
            <span
              className={cn(
                ...
                hovered === idx || (visible && item.isModal) ? "text-white" : "text-black dark:text-white"
              )}
            >
              {item.name}
            </span>
