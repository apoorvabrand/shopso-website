...
function buildTemplate(params: {
  ...
  const wrapperBottom = `
            ...
            <tr>
              <td align="center" style="padding:24px 28px;">
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    <td style="padding:0 8px;"><a href="https://x.com/ShopSoSocial" target="_blank"><img src="https://img.icons8.com/?size=100&id=phOKFKYpe00C&format=png&color=000000" width="28" height="28" alt="X/Twitter" style="display:block;border:0;"/></a></td>
                    <td style="padding:0 8px;"><a href="https://www.linkedin.com/company/shopso/" target="_blank"><img src="https://img.icons8.com/color/48/linkedin.png" width="28" height="28" alt="LinkedIn" style="display:block;border:0;"/></a></td>
                    ...
                    <td style="padding:0 8px;"><a href="https://www.instagram.com/shopso.ai" target="_blank"><img src="https://img.icons8.com/color/48/instagram-new--v1.png" width="28" height="28" alt="Instagram" style="display:block;border:0;"/></a></td>
                  </tr>
                </table>
              </td>
            </tr>
            <tr>
              <td style="padding:24px 28px;background-color:#f9fafb;font-family:${fontStack};color:#6b7280;font-size:12px;line-height:1.5; text-align: center;">
                You’re receiving this email because you subscribed to updates from ShopSo.
  ...
  if (params.source === "newsletter") {
    return {
      subject: "Welcome to the ShopSo Newsletter!",
      text: `Hi ${firstName}, you're officially on the list! Thanks for subscribing to the ShopSo newsletter.`,
      html: `
        ${wrapperTop}
          <tr>
            <td style="padding:32px 28px 16px 28px;font-family:${fontStack};color:#111111; line-height: 1.6;">
              ...
              <p style="margin:0 0 18px 0;font-size:16px;color:#374151;">🎉 Thanks for subscribing to the <strong>ShopSo</strong> newsletter. Get ready for exclusive product updates, industry insights, and best practices delivered right to your inbox. We're thrilled to have you with us!</p>
            </td>
          </tr>
          <tr>
            <td align="left" style="padding:0 28px 28px 28px;">
              <a href="https://shopso.com" target="_blank" style="background-color:${brandColor};color:${darkColor} !important;text-decoration:none;font-family:${fontStack};font-size:16px;font-weight:bold;border-radius:8px;display:inline-block;padding:14px 24px;text-align:center;">
                <span style="color:${darkColor} !important; text-decoration:none;">Schedule a Demo</span>
              </a>
            </td>
          </tr>
          <tr>
            <td style="padding:0 28px 28px 28px;font-family:${fontStack};color:#374151;font-size:16px;">— The ShopSo Team</td>
          </tr>
        ${wrapperBottom}
      `,
    };
  ...
  if (params.source === "demo_request") {
    return {
      subject: "Your ShopSo Demo Request",
        ...
        ${wrapperTop}
          <tr>
            <td style="padding:32px 28px 16px 28px;font-family:${fontStack};color:#111111; line-height: 1.6;">
              ...
              <p style="margin:0 0 16px 0;font-size:16px;color:#374151;">Hi ${firstName},</p>
              <p style="margin:0 0 18px 0;font-size:16px;color:#374151;">🙌 We've received your request for a personalized demo of <strong>ShopSo</strong>. Our team is excited to show you how our platform can help you achieve your goals.</p>
              ${
  ...
  return {
    ...
    text: `Hi ${firstName}, thanks for contacting ShopSo. We’ve received your message and will get back to you soon.`,
    html: `
      ${wrapperTop}
        <tr>
          <td style="padding:32px 28px 16px 28px;font-family:${fontStack};color:#111111; line-height: 1.6;">
            ...
            <p style="margin:0 0 16px 0;font-size:16px;color:#374151;">Hi ${firstName},</p>
            <p style="margin:0 0 18px 0;font-size:16px;color:#374151;">📩 Thanks for reaching out to <strong>ShopSo</strong>. We’ve received your message and our team will get back to you as soon as possible (usually within one business day).</p>
          </td>
        </tr>
         <tr>
            <td align="left" style="padding:0 28px 28px 28px;">
              <a href="https://shopso.com/contact" target="_blank" style="background-color:${brandColor};color:${darkColor} !important;text-decoration:none;font-family:${fontStack};font-size:16px;font-weight:bold;border-radius:8px;display:inline-block;padding:14px 24px;text-align:center;">
