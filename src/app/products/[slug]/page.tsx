...
export default function ProductPage() {
    ...
    const slugMap: Record<string, keyof typeof productsData> = {
        'shopify-integration': 'shopify-analytics',
    ...
    const mappedSlug = slugMap[slug as string] || slug as keyof typeof productsData;
    const product = productsData[mappedSlug];
