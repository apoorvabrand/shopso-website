    ...
    return (
        <div className="min-h-screen bg-white dark:bg-black px-4 py-8 md:py-16 text-black dark:text-white relative overflow-hidden ">
            <div className="absolute inset-x-0 top-0 h-64 pointer-events-none z-0 blur-3xl opacity-40 dark:opacity-20 mt-50"
                style={{ background: "radial-gradient(ellipse at center, #7c3aed 0%, transparent 80%)" }} />

            <div className="relative z-10 max-w-4xl mx-auto text-center space-y-6 md:space-y-8 mt-20">
                {/* <button className="text-xs px-4 py-1 rounded-full border dark:border-white/20 border-black/20 dark:text-white text-black hover:bg-[#7c3aed] hover:text-black transition">
                    Contact
                </button> */}
                ...
                <div className="mt-6 md:mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                    ...
                    <div className="relative group">
                        <div className="absolute inset-0 bg-[#7c3aed] rounded-xl blur-xl opacity-20 group-hover:opacity-30 transition-opacity duration-300" />
                        <div className="relative bg-white/80 dark:bg-black/90 backdrop-blur-md rounded-xl p-4 md:p-6 shadow-lg border border-white/20 dark:border-white/10 text-left">
                            ...
                            <p className="text-gray-700 dark:text-gray-300 text-sm md:text-base">info@shopso.apoorvaverma.in</p>
                        </div>
                    </div>
                    ...
                    <div className="relative group">
                        ...
                        <div className="relative bg-white/80 dark:bg-black/90 backdrop-blur-md rounded-xl p-4 md:p-6 shadow-lg border border-white/20 dark:border-white/10 text-left">
                            ...
                            <p className="text-gray-700 dark:text-gray-300 text-sm md:text-base">+91 9871629595</p>
                        </div>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="relative group mt-6 md:mt-8">
                    <div className="absolute inset-0 bg-[#7c3aed] rounded-xl blur-2xl opacity-10 group-hover:opacity-15 transition-opacity duration-300" />
                    <div className="relative bg-white/80 dark:bg-black/90 backdrop-blur-md rounded-xl p-6 md:p-8 shadow-lg border border-white/20 dark:border-white/10 grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                        <input
                            ...
                            required
                            className="bg-white/60 dark:bg-white/5 backdrop-blur-sm border border-white/30 dark:border-white/20 rounded-lg px-4 py-3 text-sm md:text-base dark:text-white text-black placeholder:dark:text-white placeholder:text-gray-600 focus:outline-none focus:ring-2 focus:ring-[#7c3aed]/50 focus:border-[#7c3aed]/50 transition-all"
                        />
                        <input
                            type="email"
                            name="email"
                            ...
                            <div className="flex">
                                <div className="relative">
                                    <button
                                        ...
                                        className="flex items-center gap-2 px-3 py-3 rounded-l-lg border border-white/30 dark:border-white/20 bg-white/60 dark:bg-white/5 backdrop-blur-sm text-black dark:text-white hover:bg-white/80 dark:hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-[#7c3aed]/50 transition-all"
                                    >
                                            ...
                                            >
                                                <div className="p-2 border-b border-white/20 dark:border-white/10">
                                                    <input
                                                        ...
                                                        className="w-full px-3 py-2 bg-gray-100 dark:bg-neutral-700 border border-white/30 dark:border-white/20 rounded text-black dark:text-white placeholder:text-gray-600 dark:placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-[#7c3aed]/50 text-sm"
                                                        autoFocus
                                                    />
                                                </div>
                                ...
                                <input
                                    ...
                                    className="flex-1 rounded-r-lg border-l-0 border border-white/30 dark:border-white/20 bg-white/60 dark:bg-white/5 backdrop-blur-sm px-4 py-3 text-sm md:text-base dark:text-white text-black placeholder:dark:text-white placeholder:text-gray-600 focus:outline-none focus:ring-2 focus:ring-[#7c3aed]/50 focus:border-[#7c3aed]/50 transition-all"
                                />
                            </div>
                        </div>
                        <textarea
                            ...
                            placeholder="Message..."
                            rows={4}
                            className="bg-white/60 dark:bg-white/5 backdrop-blur-sm border border-white/30 dark:border-white/20 rounded-lg px-4 py-3 text-sm md:text-base dark:text-white text-black placeholder:dark:text-white placeholder:text-gray-600 sm:col-span-2 resize-none focus:outline-none focus:ring-2 focus:ring-[#7c3aed]/50 focus:border-[#7c3aed]/50 transition-all"
                        />
                        <button
                            type="submit"
                            disabled={isSubmitting}
                            className="relative overflow-hidden bg-[#7c3aed] hover:bg-[#6d28d9] text-white font-semibold py-3 px-6 rounded-lg sm:col-span-2 transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-[#7c3aed]/30 hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-[#7c3aed]/50 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-black disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:hover:shadow-lg group"
                        >
