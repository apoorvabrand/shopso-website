...
export const sluggedContent: Record<string, PageContent> = {
    ...
    sections: [
      {
        ...
        content: [
          "ShopSo acts as a central hub for collecting and integrating data from all your industrial systems.",
  ...
  collect: {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          "ShopSo supports both modern IoT protocols and legacy systems.",
  ...
  integrate: {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          "ShopSo is built to scale from single plants to global operations.",
  ...
  analyze: {
    title: "Analyze",
    subtitle: "ShopSo: Your Manufacturing Analytics Partner for Data-Driven Excellence",
    sections: [
      {
      ...
      },
      {
        ...
        content: [
          "From a single line to multiple global sites, ShopSo scales effortlessly.",
  ...
  optimize: {
    title: "Optimize",
    subtitle: "Optimizing Manufacturing Excellence with ShopSo’s Data-Driven Analytics",
    sections: [
      {
